...
import { FormClient } from '../clients-modules/ClientDetails'
import { FormVehicule } from '../vehicules-modules/DetailVehicule'
            ...
            items={[
              {
                label: 'Client',
                key: '1',
                children: FormClient({}, false),
              },
              {
                label: 'Vehicule',
                key: '',
                children: FormVehicule({}, false),
              },
              {
                label: 'Factures',
                key: '3',
